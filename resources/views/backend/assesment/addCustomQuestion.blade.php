...
@section('content')
    ...
    <form action="{{url('save/custom/question/to/assesment')}}" method="POST" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="navigation_title">
                                ...
                                <b>This Question will be used to in the Assessment</b>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <input type="number" step=".01" name="marks" placeholder="ex. 10" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <span style="font-size: 12px;color:gray">Use Same Batch No. To create group of Question for Test</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="form-group" id="answer_mcq" style="display: none;">
                                            <label class="mb-3"><b># Write the MCQ options and select the write Answer : </b><a style="display: inline-block; background:lightgreen; padding: 1px 5px; border-radius: 4px; cursor:pointer; box-shadow: 5px 5px 15px rgb(182, 182, 182)" onclick="addExtraOption()">Click to add extra option</a></label>
