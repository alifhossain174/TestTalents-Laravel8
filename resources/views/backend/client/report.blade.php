...
<body>
    <div class="logo">
        <table style="width: 100%">
            <tr>
                <td><h2 style="font-size: 26px; color: #2d3436; display:inline-block; border-bottom: 2px solid black">REPORT CARD</h2></td>
                <td style="text-align: right"><img src="{{ public_path('frontend_assets/images/logo2.jpg') }}" style="width: 200px;"></td>
            </tr>
        </table>
    </div>
                ...
                <td style="text-align:left; width: 50%">
                    <table style="width: 100%" class="candidate_info">
                        <tr>
                            ...
                            <td>: {{Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $candidateInfo->invited_on)->format('jS F, Y')}}</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                @php
                                    ...
                                    foreach ($evaluatorsEvaluations as $value) {
                                        ...
                                        $totalGainedMarks = App\CandidateResult::where('candidate_id',$candidateInfo->id)->where('assesment_slug',$candidateInfo->assesment_slug)->where('evaluator_id', $value->evaluator_id)->sum('marks');
                    ...
                    <div class="row testimonial_slider">
                        <div class="col-lg-12 mt-2">
                            @if(isset($webcamImages[0]))
                                <img src="{{public_path('webcamImages')}}/{{$webcamImages[0]->file_name}}" style="width: 170px; border: 3px solid gray; border-radius: 4px">
                            @endif
                        </div>
                    </div>
                    @endif
    ...
    <div class="assessment_info" style="margin-top: 30px;">
        <table style="width: 100%; border-collapse: collapse;" border="1">
            <thead style="background: #1D4354;">
                <tr>
                    <td colspan="4" style="text-align: center; padding: 3px 0px; color: white; font-size: 16px; border-color: black">Assessment Information</td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="width: 15%; text-align:left; padding: 4px 5px; font-size: 14px"><b>Assessment : </b> </td>
                ...
                <tr>
                    ...
                    <td style="width: 20%; text-align:left;padding: 4px 5px;font-size: 14px "><b>Obtained Marks : </b></td>
    ...
    <div class="assessment_info">
        <table style="width: 100%;border-collapse: collapse;" border="1">
            <thead style="background: #1D4354;">
                <tr>
                    <td colspan="6" style="text-align: center; padding: 3px 0px; color: white; font-size: 16px; border-color: black">Anti Cheating Status</td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td style="width: 20%; text-align:right;padding: 4px 5px; font-size: 14px "><b>IP Address : </b></td>
                    ...
                    <td style="padding: 4px 5px; font-size: 14px"> <span style="color: red; padding-right: 5px;">NO</span></td>
                </tr>
                <tr>
                    ...
                    <td style="width: 20%; text-align:right;padding: 4px 5px; font-size: 14px "><b>Voice Recorded : </b></td>
                    <td style="padding: 4px 5px; font-size: 14px">
                        @if($candidateInfo->sound_taken > 0)
                            <span style="color: green; padding-right: 5px;">Yes</span> ({{$candidateInfo->sound_taken}} Clips)
                        @else
                            <span style="color: red; padding-right: 5px;">NO</span>
                        @endif
                    </td>
                    <td style="width: 15%; text-align:right;padding: 4px 5px; font-size: 14px "><b>Full Screen : </b></td>
                    <td style="padding: 4px 5px; font-size: 14px">
                        @php
                ...
                <tr>
                    ...
                    <td style="width: 20%; text-align:right;padding: 4px 5px; font-size: 14px "><b>Webcam Enabled : </b></td>
                    <td style="padding: 4px 5px; font-size: 14px" colspan="3">
                        @if($candidateInfo->webcam > 0)
                        <span style="color: green; padding-right: 5px;">Yes</span> ({{$candidateInfo->webcam}} Images)
                        @else
                        <span style="color: red; padding-right: 5px;">NO</span>
                        @endif
                    </td>
    ...
    <div class="assessment_info">
        <table style="width: 100%;border-collapse: collapse;" border="1">
            <thead style="background: #1D4354;">
                <tr>
                    <td style="text-align: center; padding: 3px 0px; color: white; font-size: 16px; border-color: black">SL</td>
                    <td style="text-align: center; padding: 3px 0px; color: white; font-size: 16px; border-color: black">Tests & Questions</td>
                    <td style="text-align: center; padding: 3px 0px; color: white; font-size: 16px; border-color: black">Score</td>
                </tr>
            </thead>
            <tbody>
                @php
                    ...
                    <td style="width: 12%; text-align:center; padding: 4px 5px; font-size: 14px">
                        @php
                            ...
                            foreach ($evaluatorsEvaluations as $value){
                                ...
                                $testMarks = App\CandidateResult::where('test_id',$test->test_id)->where('candidate_id',$candidateInfo->id)->where('evaluator_id', $value->evaluator_id)->where('assesment_slug',$candidateInfo->assesment_slug)->sum('marks');
                    ...
                    <td style="width: 12%; text-align:center; padding: 4px 5px; font-size: 14px">
                        @php
                            ...
                            foreach ($evaluatorsEvaluations as $value){
                                ...
                                $questionMarks = App\CandidateResult::where('question_id',$givenQuestion->question_id)->where('candidate_id',$candidateInfo->id)->where('evaluator_id', $value->evaluator_id)->where('assesment_slug',$candidateInfo->assesment_slug)->sum('marks');
    ...
    <small style="color: #132b36">*This Report is computer generated and therefore does not require any signature.</small><br>
