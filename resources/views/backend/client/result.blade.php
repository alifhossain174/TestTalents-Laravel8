...
@section('header_css')
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Hind:wght@300&family=Poppins:wght@300;400;500;600;700;800&display=swap"
        rel="stylesheet">
    <style>
        body {
            background: #F9FAFA
                    ...
                    <div class="col-lg-12">
                        <div class="assesment_details" style="margin-top: 20px; border-radius: 10px; background: white">
                            <div class="row mb-4">
                                <div class="col-lg-12">
                                    <h5
                                        style="font-family: 'Poppins', sans-serif; font-weight: 600; font-size: 18px; line-height: 22px;">
                                        Assesment : <span
                                            style="font-family: 'Hind'; font-weight: 400; font-size: 16px; line-height: 24px;">{{ App\Assesment::where('slug', $candidateInfo->assesment_slug)->first()->title }}</span>
                                    </h5>
                                </div>
                            </div>
                            <div class="row border-bottom pb-4">
                                <div class="col-lg-4 mb-2">
                                    <div style="width: 100%; padding: 30px; background: #F9FAFA; border-radius: 10px; ">
                                        <p class="mb-3"
                                            style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;">
                                            <span
                                                style="font-family: 'Poppins', sans-serif; font-weight: 500; font-size: 15px; line-height: 20px;">Invited
                                                :</span>
                                        ...
                                        <p class="mb-3"
                                            style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;">
                                            <span
                                                style="font-family: 'Poppins', sans-serif; font-weight: 500; font-size: 15px; line-height: 20px;">Status
                                                :</span>
                                            @php
                                        ...
                                        <p class="mb-3"
                                            style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;">
                                            <span
                                                style="font-family: 'Poppins', sans-serif; font-weight: 500; font-size: 15px; line-height: 20px;">Source
                                                :</span>
                                            Invitation by Email
                                        </p>
                                        ...
                                        @if ($candidateInfo->stage == 0)
                                            <p
                                                style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;">
                                                <span
                                                    style="font-family: 'Poppins', sans-serif; font-weight: 500; font-size: 15px; line-height: 20px;">Stage
                                                    :</span>
                                                Not Checked
                                            </p>
                                ...
                                <div class="col-lg-4 mb-2">
                                    <div style="width: 100%; padding: 30px; background: #F9FAFA; border-radius: 10px; ">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h5 class="mb-3"
                                                    style="font-family: 'Poppins', sans-serif; font-weight: 600; font-size: 16px; line-height: 20px;">
                                                    Tests & Questions</h5>
                                            </div>
                                            ...
                                            @foreach ($givenTests as $givenTest)
                                                <div class="col-lg-9">
                                                    <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                        class="mb-2">{!! $givenTest->test_name !!}</p>
                                                </div>
                                                <div class="col-lg-3 text-left">
                                                    <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                        ...
                                                        @php
                                                            ...
                                                            $testMarks = App\CandidateResult::where('test_id', $givenTest->test_id)
                                            ...
                                            @foreach ($givenQuestions as $givenQuestion)
                                                <div class="col-lg-9">
                                                    <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                        class="mb-2">{!! $givenQuestion->question !!}</p>
                                                </div>
                                                <div class="col-lg-3 text-left">
                                                    <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                        class="mb-2">
                                        ...
                                        <div class="row mt-2 border-top pt-2">
                                            <div class="col-lg-9">
                                                <p
                                                    style="font-family: 'Poppins', sans-serif; font-weight: 600; font-size: 15px; line-height: 20px;">
                                                    Average Score</p>
                                            </div>
                                            <div class="col-lg-3">
                                                <p
                                ...
                                <div class="col-lg-4 mb-2">
                                    <div style="width: 100%; padding: 30px; background: #F9FAFA; border-radius: 10px; ">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                    class="mb-1">Browser : </p>
                                            </div>
                                            <div class="col-lg-6 text-right">
                                                <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                    class="mb-1">
                                                    @if ($candidateInfo->browser_used != null)
                                                        <a class="btn btn-sm text-white pt-0 pb-0 rounded"
                                                            style="background: #1D4354; line-height: 20px;">{{ $candidateInfo->browser_used }}</a>
                                                    @endif
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-6 text-right">
                                                <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                    ...
                                                    @if ($candidateInfo->device_used != null)
                                                        <a class="btn btn-sm text-white pt-0 pb-0 rounded"
                                                            style="background: #1D4354; line-height: 20px;">{{ $candidateInfo->device_used }}</a>
                                                    @endif
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-6 text-right">
                                                <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                    ...
                                                    @if ($candidateInfo->os_used != null)
                                                        <a class="btn btn-sm text-white pt-0 pb-0 rounded"
                                                            style="background: #1D4354; line-height: 20px;">{{ $candidateInfo->os_used }}</a>
                                                    @endif
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-6 text-right">
                                                <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                    ...
                                                    @if ($candidateInfo->ip_address != null)
                                                        <a class="btn btn-sm text-white pt-0 pb-0 rounded"
                                                            style="background: #1D4354; line-height: 20px;">{{ $candidateInfo->ip_address }}</a>
                                                    @endif
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                    class="mb-1">Same IP or Different : </p>
                                            </div>
                                            <div class="col-lg-4 text-right">
                                                <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                    class="mb-1">
                                                    @if ($candidateInfo->ip_address_status != null)
                                                        <a class="btn btn-sm btn-danger text-white pt-0 pb-0 rounded"
                                                            style="line-height: 20px;">{{ $candidateInfo->ip_address_status }}</a>
                                                    @endif
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-4 text-right">
                                                <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                    ...
                                                    @if ($candidateInfo->sound_taken == 0)
                                                        <a class="btn btn-sm btn-danger text-white pt-0 pb-0 rounded"
                                                            style="line-height: 20px;">No</a>
                                                    @else
                                                        <a class="btn btn-sm btn-success text-white pt-0 pb-0 rounded"
                                                            style="line-height: 20px;">Yes</a>
                                                    @endif
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                    class="mb-1">Full Screen Always Active : </p>
                                            </div>
                                            <div class="col-lg-4 text-right">
                                                @php
                                        ...
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                    class="mb-1">Mouse Always inside Tab : </p>
                                            </div>
                                            <div class="col-lg-4 text-right">
                                                <p style="font-family: 'Hind', sans-serif; font-weight: 400; font-size: 15px; line-height: 24px;"
                                                    class="mb-1">
                            ...
                            <div class="navigation_item pt-3">
                                <ul>
                                    <li class="active">
                                        <a href="{{ url('print/result') }}/{{ $candidateInfo->slug }}"><i
                                        ...
                                        @foreach ($evaluatorsEvaluations as $evaluation)
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div
                                                        style="width: 100%; padding: 20px 20px 20px 20px; box-shadow: 1px 1px 15px gray; border-radius: 5px; background: floralwhite;">
                                                        <p style="font-family: Helvetica, sans-serif;">
                                                            <span style="font-weight: 600">Evaluator Name :</span> <span
                                                                style="font-weight: 600; color: #1D4354">{{ $evaluation->username }}
                                                            </span>
                                                        </p>
                                                        <hr>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 text-right">
                                                                <b class="d-block mb-2"><i
                                                                        class="fas fa-star-half-alt"></i></b>
                                                            </div>
                                                            ...
                                                            @foreach ($givenTestsByEvaluator as $givenTest)
                                                                <div class="col-lg-9">
                                                                    <p style="text-shadow: 2px 2px 5px rgb(204, 204, 204);"
                                                                        class="mb-2">{{ $givenTest->test_name }}</p>
                                                                </div>
                                                                <div class="col-lg-3 text-right">
                                                                    <p style="text-shadow: 2px 2px 5px rgb(204, 204, 204);"
                            ...
                            <div class="row pt-4">
                                <div class="col-lg-12">
                                    ...
                                    @foreach ($candidateTestimonials as $testimonial)
                                        <p style="font-family: Helvetica, sans-serif;">
                                            <span
                                                style="font-weight: 600; color: #1D4354">{{ $testimonial->referee_name }}
                                            </span><img title="Verified" style="width: 20px"
                                                src="{{ url('frontend_assets/images/verified.png') }}"><br>
                                            <span
                                                style="font-size: 14px; color: #7a8f82">{{ $testimonial->email }}</span><br>
                                            <span
                                                style="font-family: 'Brush Script MT', cursive;">{{ $testimonial->reply }}</span>
                                        </p>
                                        <hr>
                                    @endforeach
