...
@section('content')
    ...
    <section>
        <div class="single_assesment_content mb-5 mt-5">
            <div class="container bg-white pb-5">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="assesment_details" style="margin-top: 15px; margin-bottom: 0px; padding-bottom: 10px; background: #FFFAEF">
    ...
    echo "style='display:none;width: 100%'";
                                    ...
                                    <form id="questionForm_{{ $i }}" name="questionForm_{{ $i }}"
                                        ...
                                        <input type="hidden" name="test_slug" value="">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5 pl-3 pb-2 border-right">

                                                <div class="row">
                                                    <div class="col-lg-12 pb-3">
                                                        <span class="testTime" id="test_marks">Marks :
                                                            {{ $question->marks }}</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-7 pr-3 pl-4 pb-2">
                                                <div class="row">
                                                    <div class="col-lg-6 text-left">
                                                        <h4 id="question_numbering_on_top" class="question_title pt-1"
                                                            unselectable="on" onselectstart="return false;"
                                                            onmousedown="return false;">
                                                            Question
                                                            {{ $i + ($actualQuestionsOfThisTest - count($questionsOfThisTest)) }}
                                                            of {{ $actualQuestionsOfThisTest }}
                                                        </h4>
                                                    </div>
                                                    <div class="col-lg-6 text-right pb-3">
                                                        <span class="testTime">Time Remaining: <span
                                                                id="examTime_{{ $i }}">@if ($i == 1 && $candidateInfo->last_question_time_used != 0) {{ round($candidateInfo->last_question_time_used / 60, 2) }} @else {{ $question->time }} @endif</span></span>
                                                    </div>
                                                </div>
                                                ...
                                                <label class="pl_selection d-block"><b>Write Your Code Here :</label>
                                                ...
                                                <a href="javascript:void(0)" data-toggle="tooltip"
                                                    ...
                                                    class="nextBtn btn btn-success mt-3"
                                                    style="color:white;background: #1D4354">Go To Next</a>
                                                <img src="{{ url('images') }}/loader3.gif"
    ...
    <!-- Modal -->
    <div class="modal fade" id="fullScreenModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
...
@section('footer_js')
    ...
    <script>
        ...
        function timeManagement() {
            var actualTime = Number($('#examTime_' + start).html());
            num = actualTime * 60;
            intervalId = window.setInterval(function() {
                $('#examTime_' + start).html('');
                var hrs = ~~(num / 3600);
                ...
                if (num < 10) {
                    if (num % 2 == 0) {
                        $('#examTime_' + start).css("text-shadow", "5px 5px 15px gray");
                    } else {
                        $('#examTime_' + start).css("text-shadow", "none");
                    }
                    $('#examTime_' + start).css("color", "red");
                    $('#examTime_' + start).css("font-weight", "600");
                }
            }, 1000);
        }
    ...
    <script>
        ...
        function submitQuestionAnswer() {
            ...
            var skipQuestion = "<b id='skipQuestion_" + start +
                "' class='pt-3 d-block'>Are You Sure you want to skip ? <a href='javascript:void(0)' class='btn btn-sm btn-success' id='noSkip' onclick='noSkip()'>No</a> <a href='javascript:void(0)' class='btn btn-sm btn-danger' id='yesSkip' onclick='yesSkip()'>Yes</a></b>";
        ...
        function submitQuestionAnswerFinal() {
            ...
            //For getting the ckeditor value end
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // written to kill all the time interval
                    ...
                    if (start > questionDivLength) {
                        location.href = "http://127.0.0.1:8000/finish/test/" + assesment_slug_for_next_test + "/" + candidate_slug_for_next_test;
