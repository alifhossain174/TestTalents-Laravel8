            ...
            <div class="container-fluid">
                <nav class="navbar navbar-expand-lg bg-transparent ">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}">
                        <img src="{{ url('frontend_assets') }}/images/logo.png" class="img-fluid"
                            style="width: 60px; transform: scale(1.2)">
                    </a>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" style="left: -25px;">
                                    <a class="dropdown-item border-bottom customList"
                                        href="{{ url('/my/profile') }}"><i class="fas fa-user-circle"></i> My
                                        Profile</a>
                                    <a class="dropdown-item border-bottom customList"
                                        href="{{ url('/plan/billing') }}"><i class="fas fa-coins"></i> Plan &
                                        Billing</a>
                                    @if (Auth::user()->type == 1)
                                        <a class="dropdown-item border-bottom customList"
                                            href="{{ url('/view/custom/quotations') }}"><i
                                                class="fas fa-dollar-sign"></i> Custom Quotations</a>
                                    @endif
                                    {{-- <a class="dropdown-item border-bottom customList" href="#"><i class="fas fa-building"></i> Company Profile</a> --}}
                                    <a class="dropdown-item customList" href="{{ route('logout') }}"
                                        onclick="event.preventDefault();
                                    document.getElementById('logout-form').submit();"><b><i
                                                class="fas fa-sign-out-alt"></i> Logout</b></a>
                                </div>
                            </li>
