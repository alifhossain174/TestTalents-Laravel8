                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 text-right">
                        <div class="navigation_item pt-2">
                            <ul>
                                <li class="active">
                                    <button style="cursor: pointer" onclick="saveQuestionsOfTest()"><i
                                            class="far fa-calendar-check"></i> Submit Question <img
                                            src="{{ url('images') }}/loader3.gif"
                                            style="height:25;width:25px;margin-right:5px; display:none"
                                            id="loading"></button>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="assesment_details">
                            <div class="row">
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <select name="question_type" id="question_type_select"
                                                                class="form-control" onchange="showHideInputs(this.value,1)"
                                                                required>
                                                                <option value="">Select One</option>
                                                                <option value="1">Multiple Choice (One or Multiple
                                                                    Correct Answers)</option>
                                                                <option value="2">Essay (Open Text Answer)</option>
                                                                <option value="3">Image/PDF/Video/Audio (One or
                                                                    Multiple Correct Answers)</option>
                                                                <option value="4">Image/PDF/Video/Audio (Open Text
                                                                    Answer)</option>
                                                ...
                                                <div class="form-group" id="question_file_1" style="display: none">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <input type="file" id="question_file_input_1"
                                                                name="question_file"
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <input name="time" placeholder="ex. 10"
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <input name="marks" placeholder="Question Marks"
                                                                onkeypress="return onlyNumberKey(event)"
                                                                class="form-control" required>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-7">
                                                ...
                                                <div class="form-group" id="answer_mcq_1" style="display: none;">
                                                    <label class="mb-3"><b># Write the MCQ options and select the write
                                                            Answer : </b><a
                                                            style="display: inline-block; background:lightgreen; padding: 1px 5px; border-radius: 4px; cursor:pointer; box-shadow: 5px 5px 15px rgb(182, 182, 182)"
                                                            onclick="addExtraOption(1)">Click to add extra
                                                            option</a></label>
                                                    <div class="row" id="add_new_option_1">
                                                        <div id="remove_11" class="col-lg-1 text-right pr-0 pt-2 mb-1">
                                                            <input class="" name='answer[]' type="radio"
                                                                value="1">
                                                        </div>
                                                        ...
                                                        <div id="remove_11" class="col-lg-1 text-left pl-0">
                                                            <a class="d-block pt-1 text-danger" style="cursor:pointer"
                                                                onclick="removeOption(1,1)"><i
                                                ...
                                                <div class="form-group" id="coding_textfield_1" style="display: none;">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <select name="programming_language"
                                                                id="programming_language_1" class="form-control select2">
                                                    ...
                                                    <a class="btn btn-sm btn-success rounded mt-1 mb-2 text-white"
                                                        id="execute_1" onclick="runMyCode(1)"><img
                                                            src="{{ url('images') }}/loader3.gif"
                                                            style="height:17px;width:17px;margin-right:5px;display:none"
                                                            id="loading1"><b>Execute</b></a>
                                                    <label class="d-block">See the Results Here :</label>
                                                    <div id="result1"
                                                        style="width: 100%; min-height: 100px; background:rgb(213, 213, 213); border-radius: 5px; padding: 5px 10px">
                                ...
                                <div class="col-lg-12">
                                    <button class="btn rounded text-white mt-3" onclick="createAnotherQuestion()"
                                        style="background: #1D4354; border-color: #1D4354">Add Another Question</button>
                                </div>
...
@section('footer_js')
    ...
    <script>
        ...
        function createAnotherQuestion() {
            ...
            var anotherQuestionSection = "<div class='col-lg-12 pt-3 questionFormSection' id='questionFormSection_" +
                questionSerial + "'>" +
                "<form id='questionForm_" + questionSerial + "' name='questionForm_" + questionSerial +
                "' class='form-horizontal'>" +
                "<b class='alert alert-info d-block w-100'>" +
                "<div class='row'>" +
                "<div class='col-lg-8'># Question " + questionSerial + "</div>" +
                "<div class='col-lg-4 text-right'>" +
                "<a href='javascript:void(0)' onclick='removeQuestionSection(" + questionSerial +
                ")' class='text-danger font-weight-bolder'><i class='far fa-trash-alt'></i></a>" +
                "</div>" +
                "</div>" +
                "</b>" +
                "<hr style='margin-top: 10px !important; margin-bottom: 15px !important;'>" +
                ...
                "<div class='col-lg-12'>" +
                "<label><b>Question Type :</b></label>" +
                "<select name='question_type' id='question_type_select' class='form-control' onchange='showHideInputs(this.value," +
                questionSerial + ")' required>" +
                "<option value=''>Select One</option>" +
                ...
                "<label><b>Question :</b></label>" +
                "<textarea name='question' id='question_" + questionSerial +
                "' placeholder='Write the Question Here' class='form-control' required></textarea>" +
                "</div>" +
                "</div>" +
                "</div>" +
                ...
                "<div class='col-lg-12'>" +
                "<label><b>Upload File :</b></label>" +
                "<input type='file' id='question_file_input_" + questionSerial +
                "' name='question_file' onchange='document.getElementById('blah" + questionSerial +
                "').src='window.URL.createObjectURL(this.files[0])' class='form-control'>" +
                "</div>" +
                "</div>" +
                ...
                "<a style='display: inline-block; background:lightgreen; padding: 1px 5px; border-radius: 4px; cursor:pointer; box-shadow: 5px 5px 15px rgb(182, 182, 182)' onclick='addExtraOption(" +
                questionSerial + ")'>Click to add extra option</a>" +
                "</label>" +
                ...
                "<a class='d-block pt-1 text-danger' style='cursor:pointer' onclick='removeOption(" + questionSerial +
                ",1)'>" +
                ...
                "<div class='col-lg-12'>" +
                "<label><b># Select Programming Language (Required) :</b></label>" +
                "<select name='programming_language' id='programming_language_" + questionSerial +
                ...
                "<a class='btn btn-sm btn-success rounded mt-1 mb-2 text-white' id='execute_" + questionSerial +
                "' onclick='runMyCode(" + questionSerial + ")'>" +
                "<img src='" + window.location.origin +
                "/images/loader3.gif' style='height: 17px;width:17px;margin-right:5px;display:none' id='loading" +
                questionSerial + "'>" +
                "<b>Execute</b>" +
                "</a>" +
                ...
                "<div id='result" + questionSerial +
                "' style='width: 100%; min-height: 100px; background:rgb(213, 213, 213); border-radius: 5px; padding: 5px 10px'>" +

                "</div>" +

                "<script>" +
                "var editor" + questionSerial + " = CodeMirror.fromTextArea(document.getElementById('codeEditor" +
                questionSerial + "'), {" +
                "mode: 'javascript'," +
                "theme: 'material'," +
                "autoCloseTags: true," +
                    ...
                    if (id != 1) {
                        $.ajax({
                            ...
                            success: function(data) {
                                $('#programming_language_' + id).append(
                                    '<option value="">Select Programming Language</option>');
                                $.each(data, function(key, value) {
                                    $("select[id='programming_language_" + id + "']").append(
        ...
        function addExtraOption(id) {
            ...
            var extraOption = "<div id='remove_" + id + radio_button_val + "' class='col-lg-1 text-right pr-0 pt-2 mb-1'>" +
                ...
                "<a class='d-block pt-1 text-danger' style='cursor:pointer' onclick='removeOption(" + id + "," +
                radio_button_val + ")'><i class='fas fa-times'></i></a>" +
                "</div>";
        ...
        function saveQuestionsOfTest() {
            ...
            for (validation_serial; validation_serial <= max_validation_serial; validation_serial++) {
                ...
                var questionType = $('#questionFormSection_' + validation_serial).find('select[name="question_type"]')
                    .val();
